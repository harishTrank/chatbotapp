...
const Groupmodal = ({ setGroupPopupFlag }: any) => {
    ...
    const searchUserClickHandler = (user: any) => {
        setGroupList((oldValue: any) => {
            return oldValue?.find((record: any) => record._id === user._id) ? oldValue : [...oldValue, user]
        })
        setSearchFlag(false);
        setSearchUserState("");
    };
            ...
            <div className="create-group">
                <div className="inside-group">
                    ...
                    <div className="group-body">
                        ...
                        <input value={groupName} onChange={(e) => setGroupName(e.target.value)} type="text" placeholder='Enter Group Name...' />
                    </div>
                    <div className="group-body">
                        <div className="input-group">
                            <input type="text" className="form-control" placeholder="Search..." onChange={(e) => onChangeHandler(e.target.value)} value={searchUserState} />
                            <div
                                className="all-users"
                                style={{
                            ...
                            <ul>
                                {groupList && groupList.map((item: any) => {
                                    return (
                                        <li key={item._id}>
                                            {item.name}
                                            <i onClick={() => removeUserHandler(item._id)} className="fa-solid fa-circle-xmark"></i>
                                        </li>
                                    )
                                })}
                            </ul>
                    ...
                    <div className="create-btn">
                        <input onClick={createGroupHandler} type="submit" className='btn btn-info' value="Create Group" />
                    </div>
                </div>
            </div>
        </>
